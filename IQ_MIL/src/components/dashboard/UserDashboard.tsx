      ...
      {showAssignedOverlay && (
        <div className={styles.warningOverlay} role="alert" aria-live="assertive">
          <div className={styles.warningBox}>
            ...
            <h4 className={styles.warningTitle}>Ya tienes un caso asignado actualmente</h4>
            <p className={styles.warningText}>Debes cerrarlo antes de solicitar uno nuevo.</p>
            <p className={styles.warningNote}>
              Si consideras que es un error, contacta al administrador para que te asigne un líder.
            </p>
          </div>
        </div>
      )}
